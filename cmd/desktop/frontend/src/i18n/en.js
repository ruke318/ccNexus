export default {
    ...
    endpoints: {
        title: 'Endpoints',
        claudePanel: 'Claude Code Endpoints',
        codexPanel: 'Codex Endpoints',
        addClaude: 'Add Claude Endpoint',
        addCodex: 'Add Codex Endpoint',
        loadingClaude: 'Loading Claude endpoints...',
        loadingCodex: 'Loading Codex endpoints...',
        name: 'Name',
        apiUrl: 'API URL',
    ...
    codexPool: {
        title: 'Codex Pool',
        subtitle: 'Manage multiple org/workspace logins as slots and switch them automatically through pools',
        refresh: 'Refresh',
        slots: 'Slots',
        pools: 'Pools',
        slotsHelp: 'Each slot maps to an isolated `CODEX_HOME` login state directory',
        poolsHelp: 'Bind multiple slots into a reusable pool for Codex endpoints',
        ...
        editPool: 'Edit Pool',
        slotName: 'Slot Name',
        slotNamePlaceholder: 'e.g., org-a-main',
        slotNameRequired: 'Slot name is required',
        slotRemarkPlaceholder: 'e.g., Plus quota, Team B',
        slotEnabledHelp: 'Disabled slots will not be selected by pools',
        accountId: 'Account ID',
        accountIdPlaceholder: 'Optional, manual input or auto-filled after login',
        accountIdHelp: 'Optional. It can be detected automatically after login and sync',
        stateDir: 'State Dir',
        cooldown: 'Cooldown Left',
        lastUsedAt: 'Last Used',
        slotSaved: 'Slot saved',
        slotDeleted: 'Slot deleted',
        slotSynced: 'Slot status refreshed',
        slotNotFound: 'Slot not found. Refresh and try again.',
        login: 'Login',
        sync: 'Sync',
        loginLaunched: 'Browser auth opened. Finish the login flow in your browser.',
        loginLaunchFailed: 'Failed to open browser auth: {error}',
        poolName: 'Pool Name',
        poolNamePlaceholder: 'e.g., codex-team-pool',
        poolNameRequired: 'Pool name is required',
        poolSaved: 'Pool saved',
        poolDeleted: 'Pool deleted',
        poolNotFound: 'Pool not found. Refresh and try again.',
        poolSlotsRequired: 'Select at least one slot',
        bindSlots: 'Bind Slots',
        bindSlotsHelp: 'Selected slots will participate in rotation and failover',
        noSlotsForPool: 'No slots yet. Create and log in a slot first.',
        slotCount: 'Slot Count',
        strategy: 'Strategy',
        strategyRoundRobin: 'Round Robin',
        cooldown429Sec: '429 Cooldown (s)',
        cooldown5xxSec: '5xx Cooldown (s)',
        authExpiredPolicy: 'Auth Expired Policy',
        authExpiredSkip: 'Skip expired slots',
        enabled: 'Enabled',
        disabled: 'Disabled',
        boundSlots: 'Bound Slots',
        noSlots: 'No slots configured yet',
        noPools: 'No pools configured yet',
        noExtraInfo: 'No extra info',
        loadFailed: 'Failed to load Codex pool data: {error}',
        saveFailed: 'Failed to save: {error}',
        deleteFailed: 'Failed to delete: {error}',
        syncFailed: 'Failed to sync: {error}',
        confirmDeleteSlot: 'Delete slot "{name}"?',
        confirmDeletePool: 'Delete pool "{name}"?',
        cooldownUntil: 'Cooling down until {time}',
        minutes: ' min',
        pool: 'Pool',
        statusValues: {
            ready: 'Ready',
    ...
    modal: {
        ...
        apiUrlHelp: 'Normal endpoints use a provider URL; Codex Pool uses the ChatGPT Codex backend automatically',
        authType: 'Auth Mode',
        authTypeApiKey: 'API Key',
        authTypeCodexPool: 'Codex Pool',
        authTypeHelp: 'Use API Key for normal endpoints; Codex Pool routes to the ChatGPT Codex backend',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'e.g., sk-ant-api03-...',
        togglePassword: 'Show/Hide Key',
        codexPool: 'Codex Pool',
        selectCodexPool: 'Select a pool',
        codexPoolHelp: 'This endpoint will pick a slot from the selected pool and use the Codex backend',
        proxy: 'Proxy URL',
        proxyPlaceholder: 'e.g., http://127.0.0.1:7890 or socks5://127.0.0.1:1080',
        proxyHelp: 'Optional: Override proxy for this endpoint only',
        transformer: 'Transformer',
        ...
        port: 'Port',
        claudePortLabel: 'Claude Port (1-65535):',
        codexPortLabel: 'Codex Port (1-65535):',
        ...
        poolRequired: 'Please select a Codex pool',
    ...
    tips: [
        ...
        'Tip: Click the port numbers in header to change listening ports',
    ...
    assistant: {
        ...
        loading: 'Loading...',
        fileNotFound: 'Config file not found, click "Create" to initialize',
        ...
        conflictConfirm: 'File modified externally, overwrite?',
        error: 'Error',
        preview: 'Preview',
        jsonDocPlaceholder: 'JSON Configuration Documentation'
    },
    skills: {
        title: 'Skills Management',
        directories: 'Directories',
        selectDirectory: 'Please select a directory from the left',
        skillMdNotFound: 'SKILL.md not found in this directory',
        createHint: 'Please create SKILL.md in ~/.claude/skills/{dir}/',
        emptyState: '~/.claude/skills directory is empty',
        loadError: 'Failed to load',
        saveSuccess: 'Saved successfully',
        saveError: 'Failed to save',
        noFileSelected: 'No file selected',
        conflictError: 'File has been modified externally. Reload?'
    }
};
