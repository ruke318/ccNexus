export default {
    ...
    endpoints: {
        title: '端点列表',
        claudePanel: 'Claude Code 端点',
        codexPanel: 'Codex 端点',
        addClaude: '添加 Claude 端点',
        addCodex: '添加 Codex 端点',
        loadingClaude: '加载 Claude 端点中...',
        loadingCodex: '加载 Codex 端点中...',
        name: '名称',
        apiUrl: 'API 地址',
        transformer: '转换器',
        model: '模型',
    ...
    codexPool: {
        title: 'Codex 号池',
        subtitle: '把多个组织 / workspace 的登录态做成 slot 池，按 pool 自动切换',
        refresh: '刷新',
        slots: 'Slots',
        pools: 'Pools',
        slotsHelp: '每个 slot 对应一个独立的 `CODEX_HOME` 登录态目录',
        poolsHelp: '把多个 slot 绑成池，给 Codex 端点复用',
        loadingSlots: '加载 slot 中...',
        loadingPools: '加载 pool 中...',
        addSlot: '新增 Slot',
        editSlot: '编辑 Slot',
        addPool: '新增 Pool',
        editPool: '编辑 Pool',
        slotName: 'Slot 名称',
        slotNamePlaceholder: '例如：org-a-main',
        slotNameRequired: '请填写 Slot 名称',
        slotRemarkPlaceholder: '例如：Plus 额度、Team B',
        slotEnabledHelp: '关闭后不会参与池子分配',
        accountId: 'Account ID',
        accountIdPlaceholder: '可选，手填或登录后自动回填',
        accountIdHelp: '不填也行，登录并同步状态后会自动识别',
        stateDir: '状态目录',
        cooldown: '冷却剩余',
        lastUsedAt: '最近使用',
        slotSaved: 'Slot 保存成功',
        slotDeleted: 'Slot 删除成功',
        slotSynced: 'Slot 状态已刷新',
        slotNotFound: 'Slot 不存在，请刷新后重试',
        login: '登录',
        sync: '刷新状态',
        loginLaunched: '已打开浏览器授权，请在浏览器里完成登录',
        loginLaunchFailed: '打开浏览器授权失败：{error}',
        poolName: 'Pool 名称',
        poolNamePlaceholder: '例如：codex-team-pool',
        poolNameRequired: '请填写 Pool 名称',
        poolSaved: 'Pool 保存成功',
        poolDeleted: 'Pool 删除成功',
        poolNotFound: 'Pool 不存在，请刷新后重试',
        poolSlotsRequired: '至少选择一个 Slot',
        bindSlots: '绑定 Slots',
        bindSlotsHelp: '被选中的 slot 会参与轮询与自动切换',
        noSlotsForPool: '还没有 slot，先去左边新增并登录',
        slotCount: 'Slot 数',
        strategy: '策略',
        strategyRoundRobin: '轮询',
        cooldown429Sec: '429 冷却(秒)',
        cooldown5xxSec: '5xx 冷却(秒)',
        authExpiredPolicy: '认证过期策略',
        authExpiredSkip: '跳过失效 slot',
        enabled: '启用',
        disabled: '禁用',
        boundSlots: '绑定 Slots',
        noSlots: '还没有配置 Slot',
        noPools: '还没有配置 Pool',
        noExtraInfo: '暂无额外信息',
        loadFailed: '加载 Codex 号池失败：{error}',
        saveFailed: '保存失败：{error}',
        deleteFailed: '删除失败：{error}',
        syncFailed: '同步失败：{error}',
        confirmDeleteSlot: '确认删除 Slot “{name}” 吗？',
        confirmDeletePool: '确认删除 Pool “{name}” 吗？',
        cooldownUntil: '冷却到 {time}',
        minutes: '分钟',
        pool: 'Pool',
        statusValues: {
            ready: '可用',
    ...
    modal: {
        ...
        apiUrlHelp: '普通端点填写服务地址；Codex Pool 模式会自动使用 ChatGPT Codex backend',
        authType: '认证方式',
        authTypeApiKey: 'API Key',
        authTypeCodexPool: 'Codex Pool',
        authTypeHelp: '普通 API 用 API Key；Codex Pool 模式会直连 ChatGPT Codex backend',
        apiKey: 'API 密钥',
        apiKeyPlaceholder: '例如：sk-ant-api03-...',
        togglePassword: '显示/隐藏密钥',
        codexPool: 'Codex Pool',
        selectCodexPool: '请选择一个 Pool',
        codexPoolHelp: '绑定后，这个端点会从选中的 Pool 里自动挑 slot，并走 Codex 专用后端',
        proxy: '代理地址',
        proxyPlaceholder: '例如：http://127.0.0.1:7890 或 socks5://127.0.0.1:1080',
        proxyHelp: '可选：仅对该端点生效的代理',
        transformer: '转换器',
        ...
        changePort: '修改端口',
        port: '端口',
        claudePortLabel: 'Claude 端口号 (1-65535)：',
        codexPortLabel: 'Codex 端口号 (1-65535)：',
    ...
    assistant: {
        ...
        create: '创建配置文件',
        loading: '加载中...',
        fileNotFound: '配置文件不存在，点击"创建"按钮初始化',
        jsonError: 'JSON 格式错误',
        invalidJSON: 'JSON 格式验证失败',
        saveSuccess: '保存成功',
        saveFailed: '保存失败',
        unsavedChanges: '当前文件有未保存的更改，确定要离开吗？',
        createSuccess: '创建成功',
        createFailed: '创建失败',
        fileExists: '文件已存在',
        loadFailed: '加载失败',
        permissionDenied: '权限不足，无法访问文件',
        conflictConfirm: '文件已被外部修改，是否覆盖？',
        error: '错误',
        preview: '预览',
        jsonDocPlaceholder: 'JSON 配置文件说明'
    },
    skills: {
        title: 'Skills 管理',
        directories: '目录',
        selectDirectory: '请从左侧选择一个目录',
        skillMdNotFound: '该目录下没有 SKILL.md 文件',
        createHint: '请在 ~/.claude/skills/{dir}/ 目录下创建 SKILL.md',
        emptyState: '~/.claude/skills 目录为空',
        loadError: '加载失败',
        saveSuccess: '保存成功',
        saveError: '保存失败',
        noFileSelected: '未选择文件',
        conflictError: '文件已被外部修改，是否重新加载？'
    }
};
